...
This project is indexed by GitNexus as **Go-HRM** (10821 symbols, 27075 relationships, 272 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
