...
- [ ] **Step 1: Scaffold handler with shared helpers + admin routes + self routes**
...
- [ ] **Step 1: Add storage wire-up + services + handlers + routes**
...
- [ ] **Step 4: Spot-check swagger paths**
