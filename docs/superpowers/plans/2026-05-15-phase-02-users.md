...
- [ ] **Step 1: Confirm users table is auth-only**
...
- [ ] **Step 2: Confirm employees table exists with HR columns**
...
- [ ] **Step 3: Confirm dependents table exists**
...
- [ ] **Step 4: Confirm Phase 1 wired `EmployeeRepository` and `DependentRepository` (or only Employee)**
...
- [ ] **Step 1: Write `migrations/000003_phase2_extras.up.sql`**
...
- [ ] **Step 2: Write `migrations/000003_phase2_extras.down.sql`**
...
- [ ] **Step 5: Roll back and re-apply to confirm down.sql works**
...
- [ ] **Step 3: Wire `LoadStorageConfig` into the existing `Config` aggregate in `internal/config/config.go`**
...
- [ ] **Step 1: Create `internal/models/device_token.go`**
...
- [ ] **Step 2: Create `internal/models/employee_leave_quota.go`**
...
- [ ] **Step 3: Create `internal/models/user_notification_settings.go`**
...
- [ ] **Step 1: Append permission constants in the `const ( ... )` block**
...
- [ ] **Step 4: Build + run registry test (if present from Phase 1)**
