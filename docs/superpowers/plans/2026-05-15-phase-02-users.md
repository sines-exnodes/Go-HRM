...
- [ ] **Step 2: Mock upload service for tests**
...
- [ ] **Step 3: Introduce `Uploader` interface in `employee_service.go`**
...
- [ ] **Step 4: Write `internal/services/employee_service_test.go`**
...
- [ ] **Step 5: Write `internal/services/dependent_service_test.go`**
...
- [ ] **Step 6: Write `internal/services/user_service_test.go`**
