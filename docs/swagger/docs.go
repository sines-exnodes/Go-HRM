...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/announcements/{id}": {
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "announcement is published or archived",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/api/v1/attendance/export/{employee_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/auth/login": {
            "post": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Invalid credentials, account deactivated, or temporarily locked",
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.Response-any"
                        }
                    },
                    "403": {
                        "description": "Missing auth:login permission",
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.Response-any"
                        }
                    }
        ...
        "/api/v1/auth/mobile/forgot-password": {
            "post": {
                "description": "Mails a 6-digit OTP to the given address. Backs both \"Send Code\"\n(Screen 1) and \"Resend Code\" (Screen 2) — the same cooldown and\nrate limit apply to each.\n\n**Unlike the web ` + "`" + `/auth/forgot-password` + "`" + `, this endpoint is NOT\nenumerate-guarded**: an unregistered or deactivated address returns\n404 so the app can show the inline \"No account found\" error (AC-05).\n\n**Limits** (all env-tunable): the code expires in ` + "`" + `OTP_EXPIRE_MINUTES` + "`" + `\n(default 10). A resend inside ` + "`" + `OTP_RESEND_COOLDOWN_SECONDS` + "`" + ` (default 60)\nreturns 429, as does exceeding ` + "`" + `OTP_MAX_REQUESTS_PER_WINDOW` + "`" + ` (default 3)\nrequests per ` + "`" + `OTP_RATE_LIMIT_WINDOW_MINUTES` + "`" + ` (default 15). Both 429s\ncarry a ` + "`" + `retry_after_seconds` + "`" + ` detail.\n\nIssuing a code invalidates any previously issued one (SR-03). Email\ndispatch is best-effort — an SMTP failure is recorded on the row and\nstill returns 200.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.OTPRequestRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.Response-github_com_exnodes_hrm-api_internal_dto_OTPRequestResponse"
                        }
                    },
                    "400": {
                        "description": "Malformed body or invalid email format",
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.Response-any"
                        }
                    },
                    ...
                    "429": {
                        "description": "Resend cooldown or rate limit hit",
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.Response-any"
                        }
                    }
        ...
        "/api/v1/auth/mobile/verify-otp": {
            "post": {
                "description": "Validates the code and returns a single-use ` + "`" + `reset_token` + "`" + `.\nSend that token to ` + "`" + `POST /api/v1/auth/reset-password` + "`" + ` to set the\nnew password — there is no separate mobile reset endpoint.\n\n**The code is consumed here** (SR-05), before the token is issued.\nBacking out of the new-password screen and re-submitting the same\ncode returns 400; the app must hold the ` + "`" + `reset_token` + "`" + `. The token\nexpires in ` + "`" + `OTP_RESET_TOKEN_EXPIRE_MINUTES` + "`" + ` (default 10).\n\nA wrong code returns 400 with a ` + "`" + `remaining_attempts` + "`" + ` detail. After\n` + "`" + `OTP_MAX_VERIFY_ATTEMPTS` + "`" + ` (default 5) wrong submissions the code is\nburned and a new one must be requested.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.OTPVerifyRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.Response-github_com_exnodes_hrm-api_internal_dto_OTPVerifyResponse"
                        }
                    },
                    "400": {
                        "description": "Incorrect, expired, or already-used code",
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.Response-any"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.InviteCreate"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.InviteAccept"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.NotificationTestRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.RoleCreate"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.RoleUpdate"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_exnodes_hrm-api_internal_dto.InviteCreate": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "github_com_exnodes_hrm-api_internal_dto.NotificationTestRequest": {
            "type": "object",
            "required": [
                "body",
                "title"
        ...
        "github_com_exnodes_hrm-api_internal_dto.OTPRequestRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "github_com_exnodes_hrm-api_internal_dto.OTPRequestResponse": {
            "type": "object",
            "properties": {
                "expires_at": {
                    "type": "string"
        ...
        "github_com_exnodes_hrm-api_internal_dto.OTPVerifyRequest": {
            "type": "object",
            "required": [
                "email",
                "otp"
        ...
        "github_com_exnodes_hrm-api_internal_dto.OTPVerifyResponse": {
            "type": "object",
            "properties": {
                "expires_at": {
                    "type": "string"
        ...
        "github_com_exnodes_hrm-api_internal_dto.Response-github_com_exnodes_hrm-api_internal_dto_OTPRequestResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.OTPRequestResponse"
                },
                "message": {
                    "type": "string"
                },
        ...
        "github_com_exnodes_hrm-api_internal_dto.Response-github_com_exnodes_hrm-api_internal_dto_OTPVerifyResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_exnodes_hrm-api_internal_dto.OTPVerifyResponse"
                },
                "message": {
                    "type": "string"
                },
        ...
        "github_com_exnodes_hrm-api_internal_dto.RoleCreate": {
            "type": "object",
            "required": [
                "level",
                "name"
        ...
        "github_com_exnodes_hrm-api_internal_dto.RoleUpdate": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
